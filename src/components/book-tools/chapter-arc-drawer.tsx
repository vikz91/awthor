...
type ChapterArcPane = "overview" | "detail";
...
export function ChapterArcDrawer({
  ...
  const [pane, setPane] = useState<ChapterArcPane>("detail");
  ...
  useEffect(() => {
    ...
    setPane(nextChapter ? "detail" : "overview");
    setError(null);
    setSaveState("idle");
  ...
  return (
    <WorkspaceInspector onOpenChange={requestOpenChange} open={open}>
      ...
      <DrawerBody className="@container flex flex-col overflow-hidden @min-[44rem]:grid @min-[44rem]:grid-cols-[22rem_minmax(0,1fr)]">
        <aside
          className={cn(
        ...
        >
          ...
          {selectedChapter ? (
            ...
            >
              ...
              <div className="grid gap-5 @min-[34rem]:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="chapter-arc-stage">Arc stage</Label>
                  <Select
                    onValueChange={(value) => value && updateArc("stage", value as ChapterArcStage)}
